...
class Home extends Component {
    ...
    componentWillMount() {
        console.log("component witll mount ####")
        // Get upcoming movies
        fetch(this.props.baseUrl + "movies?status=PUBLISHED").then( (response) => {
        ...
        // Get released movies
        fetch(this.props.baseUrl + "movies?status=RELEASED").then( (response) => {
            return response.json()
        }).then((data) => {
            this.setState({
        ...
        // Get filters
        fetch(this.props.baseUrl + "genres").then( (response) => {
            return response.json()
        }).then((data) => {
            this.setState({
        ...
        // Get artists
        fetch(this.props.baseUrl + "artists").then( (response) => {
            return response.json()
        }).then((data) => {
            this.setState({
    ...
    filterApplyHandler = () => {
        ...
        fetch(this.props.baseUrl + "movies" + encodeURI(queryString)).then((response) => response.json()).then((response) => {
            this.setState({
